...
function facturasCliente($conexionMySQL,$id){
	$respuesta=mysqli_query($conexionMySQL,"select InvoiceId,InvoiceDate,CustomerId from Invoice where CustomerId = ".$id.";");
...
//No nos retorna, nos muestra
function lineaAlinea($conexionMySQL,$idLine){
